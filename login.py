...
def halaman_login():
    ...
    # Username Entry
    username_label = ctk.CTkLabel(right_frame, text="Username", font=("Droid Serif", 12), text_color="#666666")
    ...
    # Password Entry
    password_label = ctk.CTkLabel(right_frame, text="Password", font=("Droid Serif", 12), text_color="#666666")
